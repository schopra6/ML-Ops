...
export DATASET_LOC="https://raw.githubusercontent.com/schopra6/mlops/main/datasets/dataset.csv"
...
# Get and save run ID
export RUN_ID=$(python -c "import os; from mlops import utils; d = utils.load_dict(os.getenv('RESULTS_FILE')); print(d['run_id'])")
...
export HOLDOUT_LOC="https://raw.githubusercontent.com/schopra6/mlops/main/datasets/holdout.csv"
